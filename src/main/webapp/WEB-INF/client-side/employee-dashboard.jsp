...
<form class="form-dashboard">
		...
		<tr>
			...
			<div class="btn-container">
				<a href="findEmployeeById" class="btn btn-signup">Search
					Employee</a> <a href="updateEmployee" class="btn btn-signup">Update
					Employee</a> <a href="viewAll" class="btn btn-signup">View All
					Employee</a>
			</div>
		</form>
</div>
